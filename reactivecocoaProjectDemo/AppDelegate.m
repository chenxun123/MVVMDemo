...
#import "City/Controller/CXCityViewController.h"
#import "Base/ViewModel/CXViewModelServicesImpl.h"
#import "City/ViewModel/CXCityListViewModel.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    CXViewModelServicesImpl * serviceImpl = [[CXViewModelServicesImpl alloc] initModelServicesImpl];
    
    CXCityListViewModel * cityVM = [[CXCityListViewModel alloc] initWithServices:serviceImpl params:nil];
    
    CXCityViewController * cityView = [[CXCityViewController alloc] initWithViewModel:cityVM];
    
    self.window.rootViewController = [[UINavigationController alloc] initWithRootViewController:cityView];
